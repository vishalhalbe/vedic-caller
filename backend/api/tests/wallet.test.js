...
describe('calculateDeduction (unit)', () => {
  it('60 sec at ₹60/min = ₹60',     () => expect(calculateDeduction(60, 60)).toBeCloseTo(60,   5));
  it('30 sec at ₹60/min = ₹30',     () => expect(calculateDeduction(60, 30)).toBeCloseTo(30,   5));
...
async function registerAndLogin() {
  const email    = `wallet_test_${Date.now()}${++_seq}@example.com`;
